...
const TEMPLATES = [
  ...
  { id: 'two-column-amber', title: 'Two Column Amber' },
  { id: 'two-column-eclipse', title: 'Two Column Eclipse' },
  { id: 'two-column-galaxy', title: 'Two Column Galaxy' },
  { id: 'two-column-gravity', title: 'Two Column Gravity' },
  { id: 'two-column-grow', title: 'Two Column Grow' },
  { id: 'two-column-harmony', title: 'Two Column Harmony' },
  { id: 'two-column-ocean', title: 'Two Column Ocean' },
  { id: 'two-column-pluto', title: 'Two Column Pluto' },
  { id: 'two-column-popular', title: 'Two Column Popular' },
  { id: 'two-column-uranus', title: 'Two Column Uranus' },
  { id: 'two-column-venus', title: 'Two Column Venus' },
  { id: 'two-column-victory', title: 'Two Column Victory' },
];
