            ...
            <div className="space-y-4">
              ...
              >
                {[
                  ...
                  { id: 'template-two-colum-1', name: 'Template Two Column 1' },
                  { id: 'template-two-colum-2', name: 'Template Two Column 2' },
                  { id: 'template-mixed-column', name: 'Template Mixed Column 1' },
                  { id: 'template-two-colum-3', name: 'Template Two Column 3' },
                  { id: 'template-column-4', name: 'Template Two Column 4' },
                  { id: 'template-column-5', name: 'Template Two Column 5' },
                  { id: 'template-mixed-column-2', name: 'Template Mixed Column 2' },
                  { id: 'template-mixed-column-3', name: 'Template Mixed Column 3' },
                  { id: 'template-mixed-column-4', name: 'Template Mixed Column 4' },
                  { id: 'template-mixed-column-5', name: 'Template Mixed Column 5' },
                  { id: 'template-single-column-1', name: 'Template Single Column 1' },
                  { id: 'template-single-column-2', name: 'Template Single Column 2' },
                  { id: 'template-single-column-3', name: 'Template Single Column 3' },
                  { id: 'template-single-column-4', name: 'Template Single Column 4' },
                  { id: 'template-single-column-5', name: 'Template Single Column 5' },
                  { id: 'template-ats-compliant-1', name: 'Template ATS Compliant 1' },
                  { id: 'template-ats-compliant-2', name: 'Template ATS Compliant 2' },
                  { id: 'template-ats-compliant-3', name: 'Template ATS Compliant 3' },
                  { id: 'template-ats-compliant-4', name: 'Template ATS Compliant 4' },
                  { id: 'template-ats-compliant-5', name: 'Template ATS Compliant 5' },
                  { id: 'template-ats-compliant-6', name: 'Template ATS Compliant 6' },
                  { id: 'template-ats-compliant-7', name: 'Template ATS Compliant 7' },
                  { id: 'template-ats-compliant-8', name: 'Template ATS Compliant 8' },
                  { id: 'template-ats-compliant-9', name: 'Template ATS Compliant 9' },
                  { id: 'template-ats-compliant-10', name: 'Template ATS Compliant 10' },
                  { id: 'template-industry-pro-11', name: 'Modern Edge Pro' },
                  { id: 'template-industry-pro-12', name: 'Sustainable Tech' },
                  { id: 'template-industry-pro-13', name: 'Dynamic Branding' },
                  { id: 'template-industry-pro-14', name: 'Global Consulting' },
                  { id: 'template-industry-pro-15', name: 'Minimalist Zen' },
                ].map((template) => (
