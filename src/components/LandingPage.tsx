...
export const LandingPage: React.FC<LandingPageProps> = ({
  ...
  const featuredTemplates: TemplateItem[] = [
    ...
    {
      id: "two-column-amber",
      name: "Two Column Amber",
      desc: "A warm, cohesive, and modern two-column design with subtle borders, soft amber undertones, and beautifully spaced sections.",
      tag: "Cozy Theme",
      previewColor: "#d97706",
    },
    {
      id: "two-column-eclipse",
      name: "Two Column Eclipse",
      desc: "A bold, high-contrast two column layout featuring a dark solid header and elegant typography.",
      tag: "New",
      previewColor: "#334155",
    },
    {
      id: "two-column-galaxy",
      name: "Two Column Galaxy",
      desc: "A modern, sophisticated space layout with top bar identity and 2 clear columns.",
      tag: "New",
      previewColor: "#6366f1",
    },
    {
    ...
    {
      id: "two-column-harmony",
      name: "Two Column Harmony",
      desc: "A beautifully balanced two-column layout with split background tones, elegant borders and soft typography.",
      tag: "New",
      previewColor: "#6366f1",
    },
    {
      id: "two-column-ocean",
      name: "Two Column Ocean",
      desc: "A deep, clean, and highly sophisticated two-column layout with deep sea accents, structural side borders, elegant spacing, and highly legible text layout.",
      tag: "Ocean Theme",
      previewColor: "#0284c7",
    },
    {
      id: "two-column-pluto",
      name: "Two Column Pluto",
      desc: "A sleek, icy modern two-column layout with sharp edges and clear visual hierarchy.",
      tag: "New",
      previewColor: "#0ea5e9",
    },
    {
    ...
    {
      id: "two-column-uranus",
      name: "Two Column Uranus",
      desc: "An icy, fresh, and modern double-column structure. Utilizes clean horizontal custom dividers, airy cosmic palettes, elegant typography, and zero icons.",
      tag: "Uranus Theme",
      previewColor: "#06b6d4",
    },
    {
      id: "two-column-venus",
      name: "Two Column Venus",
      desc: "A soft, elegant, and modern two-column layout with a balanced visual aesthetic and gentle curves.",
      tag: "New",
      previewColor: "#ec4899",
    },
    {
      id: "two-column-victory",
      name: "Two Column Victory",
      desc: "A prestigious and structured two column layout with strong lines and clear content separation.",
      tag: "New",
      previewColor: "#10b981",
    },
  ];
